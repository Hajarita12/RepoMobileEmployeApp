...
public class EmployeAdapter extends BaseAdapter {
    ...
    public void updateEmployeeList(List<Employe> newEmployees) {
        employees.clear();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.employe_item, parent, false);

            holder = new ViewHolder();
            holder.name = convertView.findViewById(R.id.nom);
